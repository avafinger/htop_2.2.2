...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [CPU_FREQ] = A_BOLD | ColorPair(Red,Blue),
      [CPU_TEMP] = A_BOLD | ColorPair(Red,Blue),
      [CPU_VCORE] = A_BOLD | ColorPair(Yellow,Blue),
      [GPU_TEMP] = A_BOLD | ColorPair(Yellow,Blue),
      ...
      [KERNEL_VERSION] = A_BOLD | ColorPair(Cyan,Blue),
      [DISTRO_VERSION] = A_BOLD | ColorPair(Cyan,Blue),
      [OS_VERSION] = A_BOLD | ColorPair(Cyan,Blue),
      [ARMBIAN_VERSION] = A_BOLD | ColorPair(Cyan,Blue),
   },
